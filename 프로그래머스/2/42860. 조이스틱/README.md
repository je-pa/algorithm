...
<div class="highlight"><pre class="codehilite" style="position: relative;"><code>▲ - 다음 알파벳
...
<div class="highlight"><pre class="codehilite" style="position: relative;"><code>- 첫 번째 위치에서 조이스틱을 위로 9번 조작하여 J를 완성합니다.
